...
export default function Home({ chat }: any) {
  ...
  return (
    <div>
      <div className="bg-app-bg 2xl:w-1/3 m-auto 1g:w-1/2 xl:w-1/2 md:px-8 md:pt-2 md:pb-5 min-h-screen flex flex-col">
        ...
        <div className="flex-1 px-4 flex flex-col fixed z-10 w-full bottom-0 bg-app-bg border-none outline-none">
          <div className="p-4 flex-1 " />
          <button
            type="button"
            className="mt-auto bg-grad-purple rounded-[23px] text-lg w-full h-20 mb-5 text-white font-lato font-bold"
          >
