...
export default function PricingCard() {
  return (
    <div className="md:flex md:flex-col lg:flex-row gap-8 justify-center md:items-center lg:items-stretch">
      <Card className="w-full m-0 mb-8 lg:mb-0 md:w-2/3 lg:w-1/4 p-14 rounded-3xl bg-transparent shadow-2xl border border-grad-purple cursor-pointer font-poppins">
      ...
      <Card className="relative w-full mb-8 lg:mb-0 md:w-2/3 lg:w-1/4 p-14 pb-10 rounded-3xl bg-transparent shadow-2xl border border-grad-purple cursor-pointer font-poppins bg-gradient-to-br from-app-bg via-grad-purple to-grad-green">
        <svg
          width="93"
          height="68"
          viewBox="0 0 93 68"
      ...
      <Card className="relative w-full mb-8 md:mb-0 md:w-2/3 lg:w-1/4 p-14 pb-10 rounded-3xl bg-transparent shadow-2xl border border-grad-purple cursor-pointer font-poppins">
